...
//  Digest
//
//  Created by Gary Hanson on 10/15/19.
    ...
    private func configureDataSource() {
        dataSource = UICollectionViewDiffableDataSource
            ...
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: DigestViewCell.reuseIdentifier,
        ...
        // in a real app you would have a notification for when the camera roll was successfully accessed, and that would then do this initialization
        // this will work fine after first time if the app gets the ok to access photos
